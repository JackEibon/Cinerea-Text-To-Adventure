...
public class AppFont {
	...
	static {
		try {
			base = Font.createFont(Font.TRUETYPE_FONT,
					AppFont.class.getResourceAsStream("/assets/fonts/OwreKynge.ttf"));
		} catch (Exception e) {
	...
	static {
		try {
			secondary = Font.createFont(Font.TRUETYPE_FONT,
					AppFont.class.getResourceAsStream("/assets/fonts/Alkhemikal.ttf"));
		} catch (Exception e) {
			System.out.println("Not loading...");
