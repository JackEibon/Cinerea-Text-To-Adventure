...
public class CharSheet {
    ...
    public CharSheet(String name,boolean isPlayer) {this.name=name;this.player=isPlayer;} 
    ...
    public void setHealth(int health) {
        ...
        if(this.health<=0) {this.health=0;alive=false;}
    }

    public int getMaxHealth() {return maxHealth;}
    public void setMaxHealth(int maxHealth) {this.maxHealth=maxHealth;}
    public void addHealth(int amount) {setHealth(this.health+amount);}
    
    public int getEnergy() {return energy;}
    public void setEnergy(int energy) {this.energy=energy;
    if(this.energy>maxEnergy) {this.energy=maxEnergy;}
        if(this.energy<0) {this.energy=0;tired++;}
    }
    ...
    public void addAim(int amount) {this.aim+=amount;}

    public int getDodge() {return dodge;}
    public void setDodge(int dodge) {this.dodge=dodge;}
    public void addDodge(int amount) {this.dodge+=amount;}

    public int getTired() {return tired;}
    public void setTired(int tired) {this.tired=tired;
        if(this.tired<0) {this.tired=0;}
    }

    public void addTired(int amount) {setTired(tired+amount);}
    ...
    public void addBleed(int amount) {setBleed(bleed+amount);}

    public int getAroma() {return aroma;}
    public void setAroma(int aroma) {this.aroma=aroma;
        if(this.aroma<0) {this.aroma=0;}
    }

    public void addAroma(int amount) {setAroma(aroma+amount);}
    ...
    public void setRetreating(boolean retreating) {this.retreating=retreating;}

    public boolean isBlessed() {return blessed;}
    public void setBlessed(boolean blessed) {this.blessed=blessed;}
    ...
    public boolean addStatusEffect(String effect) {
        if(statusEffects.contains(effect)) {return false;}
    ...
    public boolean learnWord(String word) {
        ...
        knownWords.add(word);return true;
    }
    public void applyEffect(String effect) {
        switch(effect) {
            case "bleed": {addBleed(1);break;}
            case "tired": {addTired(1);break;}
            case "heal": {addHealth(10);break;}
            case "rest": {recoverEnergy();break;}
            default:{break;}
        }
    }
}