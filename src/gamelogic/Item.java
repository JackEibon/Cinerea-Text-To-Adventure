...
public class Item {
	...
	/*
	 * fullName is displayed name if nessesary, i dont think we`ll reach those needs
	 * but "Silver Sword" etc. name is name of the item, nessesary for nouns
	 * lexicon-
	 * 
	 */
	...
	public void setCodename(String p) {
		this.codename = p;
	}
