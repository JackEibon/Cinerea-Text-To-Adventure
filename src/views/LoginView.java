...
public class LoginView extends JPanel {
    ...
    public LoginView(LoginWindow window) {
        ...
        // Se registra para recibir cambios de tema desde cualquier ventana con este foreach
    ...
    public void initializeCompounds() {
        ...
        btnLogin.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { changeBackground(btnLogin); }
            public void mouseExited(MouseEvent e)  { resetBackground(btnLogin); }
        });
        ...
        btnRegister.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { changeBackground(btnRegister); }
            public void mouseExited(MouseEvent e)  { resetBackground(btnRegister); }
        });
