...
public class NpcView extends JPanel {
	...
	public File selectPdfFile() {
		...
		chooser.setSelectedFile(new File(path, "npc-report.pdf")); 
		...
		int option = chooser.showDialog(this, "Export users PDF");
	...
	/*
	 * in User Controller: this.view.getBtnPdf().addActionListener(e->
	 */
