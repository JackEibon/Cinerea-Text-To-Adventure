...
public class ItemView extends JPanel {
	...
	public File selectPdfFile() {
		...
		chooser.setSelectedFile(new File(path, "items-report.pdf")); 
		...
		int option = chooser.showDialog(this, "Export items PDF");
	...
	public void setTableModel(ItemTableModel model) {
