...
public class ConfigView extends JPanel {
	...
	public File selectPdfFile() {
		...
		chooser.setSelectedFile(new File(path, "configs-report.pdf")); 
		...
		int option = chooser.showDialog(this, "Export configs PDF");
	...
	public void setTableModel(ConfigTableModel model) {
