...
/*
 * Author: Eibon
 * added in class of 24/2/2026 at 0948 from New Cinerea Netbeans Project
 * Resume: This is meant to be the "Character Sheet" class, which defines all
 * kinds of attributes about characters. Score to be added, and all
 * is meant to be simplified and heavily modded to fit the new proyects
