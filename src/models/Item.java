...
public class Item {
	...
	public boolean match(String word) {
		...
		if (this.name.toLowerCase().contains(word))
			return true;
		return hasTag(word);
	}
	...
	public boolean hasTag(String tag) {
		...
		for (String currentTag : tags) {
			if (currentTag == null)
				continue;
			if (currentTag.trim().equalsIgnoreCase(search))
				return true;
		}
		return false;
	}
...
/*
 * Old Item Model public class Item {
 * 
 * private int idItem; private String itemName; private String itemType; private
 * String description;
 * 
 * public Item() {
 * 
 ...
 * this.itemName = itemName; this.itemType = itemType; this.description =
 * description; }
 * 
 * public Item(int idItem, String itemName, String itemType, String description)
 * { this.idItem = idItem; this.itemName = itemName; this.itemType = itemType;
 * this.description = description; }
 * 
