...
public class NodeT1 {
	...
	private int aN1Cost = 999, aN2Cost = 999, aN3Cost = 999, aN4Cost = 999, aN5Cost = 999, aN6Cost = 999, aN7Cost = 999,
			aN8Cost = 999;
	private String aN1p = "none", aN2p = "none", aN3p = "none", aN4p = "none", aN5p = "none", aN6p = "none",
			aN7p = "none", aN8p = "none", imagePath = "", biome = "meadow",
			mainDescription = "there doesn’t seem to be anything interesting",
			distantDescription = "a dense mist can be seen", goDescriptions = "there is nowhere to go",
			takeDescriptions = "", restDescriptions = "", talkDescriptions = "", targetDescriptions = "",
			itemsDescriptions = "";
	...
	public NodeT1(int scene, List<String> names, String mainD, String distantD) {
		this.scene = scene;
		this.names = names;
		setDescriptions(mainD, distantD);
	}

	public NodeT1(int scene, String mainD, String distantD) {
		this.scene = scene;
		setDescriptions(mainD, distantD);
	}
	...
	public void addChar(CharSheet i) {
		characters.add(i);
	}

	public void removeChar(CharSheet i) {
		characters.remove(i);
	}

	public List<CharSheet> getChar() {
		return characters;
	}
	...
	public void setDescriptions(String main, String distant) {
		this.mainDescription = main;
		this.distantDescription = distant;
	}
	...
	public String getaN1p() {
		return aN1p;
	}

	public void setaN1p(String aN1p) {
		this.aN1p = aN1p;
	}

	public String getaN2p() {
		return aN2p;
	}

	public void setaN2p(String aN2p) {
		this.aN2p = aN2p;
	}

	public String getaN3p() {
		return aN3p;
	}

	public void setaN3p(String aN3p) {
		this.aN3p = aN3p;
	}

	public String getaN4p() {
		return aN4p;
	}

	public void setaN4p(String aN4p) {
		this.aN4p = aN4p;
	}

	public String getaN5p() {
		return aN5p;
	}

	public void setaN5p(String aN5p) {
		this.aN5p = aN5p;
	}

	public String getaN6p() {
		return aN6p;
	}

	public void setaN6p(String aN6p) {
		this.aN6p = aN6p;
	}

	public String getaN7p() {
		return aN7p;
	}

	public void setaN7p(String aN7p) {
		this.aN7p = aN7p;
	}

	public String getaN8p() {
		return aN8p;
	}

	public void setaN8p(String aN8p) {
		this.aN8p = aN8p;
	}
	...
	public void setGoDescriptions() {
		...
		int x = 1; // counter
		while (getaN(x) != null) {
			setGoDescriptions(getGoDescriptions() + getaN(x).getDistantDescription() + ", you can get there by "
					+ this.getaNp(x) + "\n");
			x++;
		}
	}
	...
	public void addTargetDescriptions(String tD) {
	...
	public List<CharSheet> getCharacters() {
		return characters;
	}

	public void setCharacters(List<CharSheet> characters) {
