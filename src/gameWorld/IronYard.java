...
public class IronYard extends NodeT1{
	...
	public IronYard(int scene) {
	    ...
	    setBiome("meadow");
	    setScene(scene);
	    setMainDescription("War leaves behind few things of value, other than memories, blood, teachings and the weapon one owns.");
	    ...
	    if(player != null) {
	        switch(player.getWeapon().toLowerCase()) {
	            case "sword":addItem(NewItem.sword(),
	                    "\nA battered sword remains among the grasslands.");
	                break;
	            case "spear":addItem(NewItem.spear(),
	            ...
	            case "gun"://addItem(NewItem.gun(),
	                ...
	                break;
	            default:addItem(NewItem.sword(),
	                    "\nA lone sword rests here.");
	        }
	    }else {addItem(NewItem.sword(),
                "\nA lone sword rests here.");}
	}
